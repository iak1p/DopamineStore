<footer class="bg-[#111111] text-white mt-16">
    <div class="container mx-auto px-3 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
            ...
            <p class="mt-4 text-sm text-[#BDBDBD] leading-6 max-w-xs">Fresh fruits, clean design, and a little daily dopamine. Bringing color and taste to your table.</p>
        </div>
        ...
        <div>
            ...
            <p class="text-sm text-[#BDBDBD] leading-6">Follow us for fresh arrivals, seasonal picks, and fruity vibes.</p>
