...
<body class="font-[Manrope]">
    ...
    <main class="container mx-auto px-3 pb-14">
        ...
        <div class="mt-6">
            <div
                class="hidden items-center gap-4 border-b border-[#EFEFEF] pb-3 text-sm font-semibold text-[#333] md:grid md:grid-cols-[1fr_90px_120px_120px_40px]"
            >
                <div>Product</div>
                <div class="text-center">DPH</div>
                <div class="text-center">Price / kg</div>
            ...
            @forelse ($cart->items as $item)
                ...
                @endphp
                <div
                    class="grid grid-cols-1 items-center gap-4 border-b border-[#EFEFEF] py-5 md:grid-cols-[1fr_90px_120px_120px_40px]"
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="text-sm text-[#666] md:hidden">
                                Price / kg: €{{ number_format($item->unit_price, 2) }}
                            </div>
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="text-xl leading-none text-red-500 hover:opacity-70"
                            title="Remove"
                        >
                            ×
                        </button>
            ...
            <div class="w-full md:ml-auto md:w-[420px]">
                ...
                <div
                    class="mt-2 flex items-center justify-between text-sm font-semibold text-[#2B662D]"
                >
